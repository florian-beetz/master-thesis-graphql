...
import de.florianbeetz.ma.graphql.order.service.InventoryService;
...
public class GraphQLConfig {
    ...
    @Autowired
    public GraphQLConfig(OrderService orderService) {
        types = Set.of(
                new GraphQLType<>("Order", Order.class, orderService::lookupOrder)
        );
    }
