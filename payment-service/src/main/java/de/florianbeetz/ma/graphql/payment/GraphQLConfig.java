package de.florianbeetz.ma.graphql.payment;
...
public class GraphQLConfig {
    ...
    @Autowired
    public GraphQLConfig(PaymentService paymentService) {
        types = Set.of(
                new GraphQLType<>("Payment", Payment.class, paymentService::lookupPayment)
        );
    }
